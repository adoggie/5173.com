...
if not _M_gtr.__dict__.has_key('IQuestionServer'):
    ...
    class IQuestionServerPrx(Ice.ObjectPrx):
    ...
    _M_gtr._t_IQuestionServer = IcePy.defineClass('::gtr::IQuestionServer', IQuestionServer, (), True, None, (), ())
...
if not _M_gtr.__dict__.has_key('GameWorkSheetTypeT'):
    _M_gtr.GameWorkSheetTypeT = Ice.createTempClass()
    class GameWorkSheetTypeT(object):
    ...
    GameWorkSheetTypeT.gwsPost = GameWorkSheetTypeT(0)
    GameWorkSheetTypeT.gwsAccountAudit = GameWorkSheetTypeT(1)
    GameWorkSheetTypeT.gwsVerify = GameWorkSheetTypeT(2)

    _M_gtr._t_GameWorkSheetTypeT = IcePy.defineEnum('::gtr::GameWorkSheetTypeT', GameWorkSheetTypeT, (), (GameWorkSheetTypeT.gwsPost, GameWorkSheetTypeT.gwsAccountAudit, GameWorkSheetTypeT.gwsVerify))

    _M_gtr.GameWorkSheetTypeT = GameWorkSheetTypeT
    del GameWorkSheetTypeT
...
if not _M_gtr.__dict__.has_key('GameTaskletT'):
    ...
    class GameTaskletT(object):
        def __init__(self, id='', type=0, no='', gameId='', account='', password='', area='', server='', lineName='', lineNo=0, createTime='', secretKey='', post=Ice._struct_marker, audit=Ice._struct_marker, verify=Ice._struct_marker):
            self.id = id
            self.type = type
            self.no = no
            self.gameId = gameId
...
if not _M_gtr.__dict__.has_key('GameTaskResultT'):
    ...
    class GameTaskResultT(object):
        def __init__(self, id='', no='', type=0, gameId='', result=0, errmsg=''):
            self.id = id
            self.no = no
            self.type = type
            self.gameId = gameId
...
if not _M_gtr.__dict__.has_key('GameInfoT'):
    ...
    class GameInfoT(object):
        def __init__(self, id=0, name='', version=''):
            self.id = id
            self.name = name
            self.version = version
