...
void
gtr::__write(::IceInternal::BasicStream* __os, ::gtr::GameWorkSheetTypeT v)
{
    __os->write(static_cast< ::Ice::Byte>(v), 3);
}

void
gtr::__read(::IceInternal::BasicStream* __is, ::gtr::GameWorkSheetTypeT& v)
{
    ::Ice::Byte val;
    __is->read(val, 3);
    v = static_cast< ::gtr::GameWorkSheetTypeT>(val);
}
