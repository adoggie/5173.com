...
const ::Ice::Int gwsPost = 1;

const ::Ice::Int gwsAccountAudit = 2;

const ::Ice::Int gwsVerify = 4;
...
class IQuestionServer : virtual public ::IceProxy::gtr::IService
{
public:
...
class IQuestionServer : virtual public ::IceDelegate::gtr::IService
{
public:
...
class IQuestionServer : virtual public ::gtr::IService
{
public:
