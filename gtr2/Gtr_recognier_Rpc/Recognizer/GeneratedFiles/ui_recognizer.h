...
**
** Created: Mon May 24 10:26:23 2010
...
public:
    ...
    void setupUi(QMainWindow *RecognizerClass)
    {
        ...
        RecognizerClass->resize(941, 650);
        RecognizerClass->setAcceptDrops(false);
        ...
        sizePolicy3.setHeightForWidth(answerLineEdit->sizePolicy().hasHeightForWidth());
        answerLineEdit->setSizePolicy(sizePolicy3);
        answerLineEdit->setMinimumSize(QSize(100, 50));
        ...
        answerLineEdit->setMaxLength(12);
        ...
        sizePolicy3.setHeightForWidth(submitPushButton->sizePolicy().hasHeightForWidth());
        submitPushButton->setSizePolicy(sizePolicy3);
    ...
    {
        RecognizerClass->setWindowTitle(QApplication::translate("RecognizerClass", "GTR\347\255\224\351\242\230\345\231\250(RPC-1.1.0)", 0, QApplication::UnicodeUTF8));
