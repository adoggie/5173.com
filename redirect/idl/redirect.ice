...
interface IRdDispatcher extends IService{
  ...
  CallResultT connectedRdServer(RdFrontInfoT front,RdServerInfoT server,RdWorkSheetT sheet);  //上报状态 
  CallResultT disconnectedRdServer(RdFrontInfoT front,RdServerInfoT server,RdWorkSheetT sheet);//上报状态 
